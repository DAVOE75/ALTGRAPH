...
class AppPreferences(context: Context) {
    ...
    var showCustomMapOverlay: Boolean
        get() = prefs.getBoolean(KEY_SHOW_CUSTOM_MAP_OVERLAY, true)
        set(value) = prefs.edit().putBoolean(KEY_SHOW_CUSTOM_MAP_OVERLAY, value).apply()

    var customMapProvider: String
        get() = prefs.getString(KEY_CUSTOM_MAP_PROVIDER, "bikespot") ?: "bikespot"
    ...
    companion object {
        ...
        private const val KEY_SHOW_CUSTOM_MAP_OVERLAY = "show_custom_map_overlay"
        private const val KEY_CUSTOM_MAP_PROVIDER = "custom_map_provider"
